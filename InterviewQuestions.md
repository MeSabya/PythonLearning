...
## What is deep copy n shallow copy? [Mamali]
...
## how do you safely access a value frm dictionary which may or may not present in dict ? [Mamali]

## how do you merge two list ? [Mamali]

## how do you merge two dicts ? [Mamali]
...
## what are generators? [Mamali]

## what is the use of global keyword ? [Mamali]

## what is the difference between global and globals? [Mamali]

## how to access doc string of an object ?

## what is the use of repr? [Mamali]

## how to reverse a string ?[Mamali]

## what is hashing ? and which is the data structure which uses hasing ? [Mamali]

## what should be the property of a key of dictionary? [Mamali]

## Can tuple be a key of dictionary? [Mamali]
...
## what is the use of with statement? [Mamali]
